...
const navItems = [
  ...
  { href: '/carga-horaria', label: 'Carga horaria', icon: 'M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 012 2m-6 9l2 2 4-4', roles: ['admin','secretaria','docente','director_escuela'] },
  ...
  { href: '/curriculas', label: 'Currículas', icon: 'M4 4h16v16H4zM7 8h10M7 12h10M7 16h6', roles: ['admin','director_escuela'] },
...
export default function AppLayout({ children }: { children: React.ReactNode }) {
  ...
  const visibleNav = navItems.filter(
    n => !user || n.roles.includes(user.rol.codigo)
  );
