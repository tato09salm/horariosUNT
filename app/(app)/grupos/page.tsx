              ...
              {loading ? (
                ...
                <tr key={g.id}>
                  ...
                  <td style={{textAlign:'center'}}>
                    <span className="badge" style={{background:darkMode?'rgba(52,211,153,0.15)':'#ecfdf5',color:darkMode?'#34d399':'#059669',padding:'4px 10px',borderRadius:'50%',width:'36px',height:'36px',display:'inline-flex',alignItems:'center',justifyContent:'center',fontWeight:'700'}}>
                      {g.numero_grupo}
                    </span>
                  </td>
                  <td className="hide-sm" style={{textAlign:'center', color: 'var(--text-primary)'}}>{g.max_alumnos}</td>
                  <td className="hide-sm" style={{textAlign:'center', color: 'var(--text-primary)'}}>{g.num_alumnos}</td>
                  <td>
                    <div style={{display:'flex',gap:'6px'}}>
                      <button className="btn-secondary btn-crud-edit" style={{padding:'5px 10px',fontSize:'12px'}} onClick={() => editar(g)}>
                      ...
                      <button className="btn-secondary btn-crud-deactivate" style={{padding:'5px 10px',fontSize:'12px'}} onClick={() => handleEliminar(g)}>
