module.exports = {
      up: async (qi) => {
        await qi.bulkInsert('usuarios', [
          ...
          { nombre: 'Sanchez', apellidos: 'Perez, Roberto', email: 'director@unitru.edu.pe', password_hash: '$2a$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', rol: 'director_escuela' }
        ], {});
      },
