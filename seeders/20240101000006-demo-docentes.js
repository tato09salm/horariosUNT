module.exports = {
      up: async (qi) => {
        ...
        try {
          ...
          { nombre: 'Segundo', apellidos: 'Guibar Obeso', dni: '77777777', email: 'sguibar@unt.edu.pe', categoria: 'principal', condicion: 'nombrado', fecha_ingreso: '2002-03-01', grado_academico: 'doctor', horas_max_semana: 20 },
          { nombre: 'Miquel', apellidos: 'Ipanaque Zapata', dni: '88888888', email: 'mipanaque@unt.edu.pe', categoria: 'asociado', condicion: 'nombrado', fecha_ingreso: '2008-03-01', grado_academico: 'magister', horas_max_semana: 20 },
          { nombre: 'Martha', apellidos: 'Cardoso', dni: '99999999', email: 'mcardoso@unt.edu.pe', categoria: 'auxiliar', condicion: 'contratado', fecha_ingreso: '2020-08-01', grado_academico: 'bachiller', horas_max_semana: 16 },
          { nombre: 'Marcos', apellidos: 'Ferrer Reyna', dni: '23232323', email: 'mferrer@unt.edu.pe', categoria: 'principal', condicion: 'nombrado', fecha_ingreso: '1999-03-01', grado_academico: 'doctor', horas_max_semana: 20 },
          { nombre: 'Teresita', apellidos: 'Rojas García', dni: '24242424', email: 'trojas@unt.edu.pe', categoria: 'asociado', condicion: 'nombrado', fecha_ingreso: '2011-03-01', grado_academico: 'magister', horas_max_semana: 20 },
          { nombre: 'Juan', apellidos: 'Carrascal Cabanillas', dni: '25252525', email: 'jcarrascal@unt.edu.pe', categoria: 'auxiliar', condicion: 'contratado', fecha_ingreso: '2016-08-01', grado_academico: 'licenciado', horas_max_semana: 16 },
          { nombre: 'Wilma', apellidos: 'Mendez Gil', dni: '26262626', email: 'wmendez@unt.edu.pe', categoria: 'principal', condicion: 'nombrado', fecha_ingreso: '2003-03-01', grado_academico: 'doctor', horas_max_semana: 20 },
          { nombre: 'Sheyla Laura', apellidos: 'Escobedo Rodriguez', dni: '27272727', email: 'sescobedo@unt.edu.pe', categoria: 'asociado', condicion: 'nombrado', fecha_ingreso: '2009-03-01', grado_academico: 'magister', horas_max_semana: 20 },
          { nombre: 'Cesar', apellidos: 'Arellano Salazar', dni: '30303030', email: 'carellano@unt.edu.pe', categoria: 'auxiliar', condicion: 'contratado', fecha_ingreso: '2017-08-01', grado_academico: 'licenciado', horas_max_semana: 16 },
          { nombre: 'Marcos', apellidos: 'Baca Lopez', dni: '32323232', email: 'mbaca@unt.edu.pe', categoria: 'asociado', condicion: 'nombrado', fecha_ingreso: '2013-03-01', grado_academico: 'magister', horas_max_semana: 20 },
          { nombre: 'Ana', apellidos: 'Cuadra Mituzgaray', dni: '33333334', email: 'acuadra@unt.edu.pe', categoria: 'auxiliar', condicion: 'contratado', fecha_ingreso: '2019-08-01', grado_academico: 'licenciado', horas_max_semana: 16 },
          { nombre: 'Zoraida', apellidos: 'Vidal Melgarejo', dni: '20202020', email: 'zvidal@unt.edu.pe', categoria: 'principal', condicion: 'nombrado', fecha_ingreso: '2001-03-01', grado_academico: 'doctor', horas_max_semana: 20 },
          { nombre: 'Everson David', apellidos: 'Agreda Gamboa', dni: '21212121', email: 'eagreda@unt.edu.pe', categoria: 'asociado', condicion: 'nombrado', fecha_ingreso: '2006-08-01', grado_academico: 'magister', horas_max_semana: 20 },
          { nombre: 'Alberto', apellidos: 'Mendoza de los Santos', dni: '22222222', email: 'amendoza@unt.edu.pe', categoria: 'asociado', condicion: 'nombrado', fecha_ingreso: '2005-08-01', grado_academico: 'magister', horas_max_semana: 20 },
          { nombre: 'Juan Carlos', apellidos: 'Obando Roldán', dni: '22222223', email: 'jobando@unt.edu.pe', categoria: 'auxiliar', condicion: 'contratado', fecha_ingreso: '2019-03-01', grado_academico: 'licenciado', horas_max_semana: 16 },
          { nombre: 'Luis', apellidos: 'Boy Chavil', dni: '28282828', email: 'lboy@unt.edu.pe', categoria: 'principal', condicion: 'nombrado', fecha_ingreso: '2004-03-01', grado_academico: 'doctor', horas_max_semana: 20 },
